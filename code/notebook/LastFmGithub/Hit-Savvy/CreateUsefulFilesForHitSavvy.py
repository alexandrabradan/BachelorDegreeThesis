...
# get_artists_with_top_playcounts_made_by_seed_users(1, 26, 37, True)
# get_artists_with_top_playcounts_made_by_seed_users(2, 26, 49, True)
# get_artists_with_top_playcounts_made_by_seed_users(3, 26, 61, True)
# get_artists_with_top_playcounts_made_by_seed_users(4, 26, 73, True)
# get_artists_with_top_playcounts_made_by_seed_users(5, 26, 85, True)

# get_artists_with_top_playcounts_made_by_seed_users(1, 38, 103, False)
# get_artists_with_top_playcounts_made_by_seed_users(2, 50, 103, False)
# get_artists_with_top_playcounts_made_by_seed_users(3, 62, 103, False)
# get_artists_with_top_playcounts_made_by_seed_users(4, 74, 103, False)
# get_artists_with_top_playcounts_made_by_seed_users(5, 86, 103, False)

# get_artists_with_top_google_searches(1, 26, 37, True)
# get_artists_with_top_google_searches(2, 26, 49, True)
# get_artists_with_top_google_searches(3, 26, 61, True)
# get_artists_with_top_google_searches(4, 26, 73, True)
# get_artists_with_top_google_searches(5, 26, 85, True)

# get_artists_with_top_google_searches(1, 38, 103, False)
# get_artists_with_top_google_searches(2, 50, 103, False)
# get_artists_with_top_google_searches(3, 62, 103, False)
# get_artists_with_top_google_searches(4, 74, 103, False)
# get_artists_with_top_google_searches(5, 86, 103, False)


# get_artists_with_top_listeners_made_by_seed_users(1, 26, 37, True)
# get_artists_with_top_listeners_made_by_seed_users(2, 26, 49, True)
# get_artists_with_top_listeners_made_by_seed_users(3, 26, 61, True)
# get_artists_with_top_listeners_made_by_seed_users(4, 26, 73, True)
# get_artists_with_top_listeners_made_by_seed_users(5, 26, 85, True)

# get_artists_with_top_listeners_made_by_seed_users(1, 38, 103, False)
# get_artists_with_top_listeners_made_by_seed_users(2, 50, 103, False)
# get_artists_with_top_listeners_made_by_seed_users(3, 62, 103, False)
# get_artists_with_top_listeners_made_by_seed_users(4, 74, 103, False)
# get_artists_with_top_listeners_made_by_seed_users(5, 86, 103, False)
